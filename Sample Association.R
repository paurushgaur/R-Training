...
itemlist1
write(itemlist1, file = "D:/R Training/Training/Market Basket Analysis/itemlist1.csv");
tdata1 = read.transactions("D:/R Training/Training/Market Basket Analysis/itemlist1.csv", format = "basket", sep=",");
summary(tdata1)
inspect(tdata1);
