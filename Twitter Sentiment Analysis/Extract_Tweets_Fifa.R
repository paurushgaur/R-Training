...
# includes popular + real time results tweets
tweets <- searchTwitter(search.string, n=no.of.tweets,lang="en")

tweets <- searchTwitter(search.string, n=no.of.tweets,lang="en",
                        since='2018-07-07' ,resultType = 'recent')
...
which(grepl("Looking forward to watch the third", tweets.text))

tweets.text <- tweets.text[-92] 
